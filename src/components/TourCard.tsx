  ...
  return (
    ...
    >
      <div className="relative aspect-[4/5] overflow-hidden">
        ...
        <div
          className={`absolute inset-0 bg-gradient-to-t from-background via-background/20 to-transparent transition-opacity duration-500 ${isHovered ? "opacity-90" : "opacity-60"}`}
        />
              ...
              <div className="flex flex-col gap-3">
                ...
                <div className="flex flex-wrap gap-2">
                  {tour.highlights.map((h, i) => (
                    <span
                      key={i}
                      className="text-[10px] bg-white/5 border border-white/10 px-2 py-1 rounded-sm uppercase tracking-widest text-white/80"
                    >
                      {h}
                    </span>
                  ))}
