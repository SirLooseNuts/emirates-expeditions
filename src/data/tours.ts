...
export const tours: Tour[] = [
  // 🗓️ ONE DAY PACKAGES
  {
    ...
    fullDescription:
      "Maximize your day in the green heart of Kerala. This itinerary is built for nature lovers who want to experience the raw wilderness of Wayanad in a single daylight loop.",
    itinerary: [
      {
        day: 1,
        title: "Wild Wayanad",
        activities: [
          "Sunrise safari at Muthanga",
          "Traditional Wayanad lunch",
          "Banasura Sagar Dam exploration",
          "Lakkidi viewpoint at sunset",
        ],
      },
    ],
  ...
  },
  {
    ...
    fullDescription:
      "A journey back in time. Marayoor offers a unique blend of natural scents and prehistoric history that you can't find anywhere else in the world.",
    itinerary: [
      {
        day: 1,
        title: "Prehistoric Loop",
        activities: [
          "Morning walk through sandalwood forests",
          "Exploring Muniyaras (Dolmens)",
          "Afternoon dip at Lakkam Falls",
          "Traditional village tea break",
        ],
      },
    ],
  ...
  },
  {
    ...
    fullDescription:
      "Winding roads, emerald slopes, and the perfect cup of tea. Our 1-day Munnar loop covers the must-see highlights without the rush.",
    itinerary: [
      {
        day: 1,
        title: "The Emerald Day",
        activities: [
          "Tea museum tour",
          "Gap Road scenic drive",
          "Echo Point shouting session",
          "Shopping at Munnar town",
        ],
      },
    ],
  ...
  },
  {
    ...
    fullDescription:
      "Perfect for a quick escape. Vagamon offers a serene landscape of meadows and pine forests that feel a world away from the city.",
    itinerary: [
      {
        day: 1,
        title: "Mist & Meadows",
  ...
  },
  {
    ...
    fullDescription:
      "Experience the soul of Kerala. Navigate through the narrow canals, witness the local village life, and enjoy a traditional meal on the water.",
    itinerary: [
      {
        day: 1,
        title: "The Liquid Road",
        activities: [
          "Motorboat boarding",
          "Canal cruising",
  ...
  },
  {
    ...
    fullDescription:
      "Stand at the base of the mighty Athirappilly falls and feel the mist. A high-energy trip for groups and families.",
    itinerary: [
      {
        day: 1,
        title: "The Mighty Drop",
        activities: [
          "Athirappilly fall base trek",
          "Vazhachal rapids visit",
          "Riverside lunch",
          "Forest drive",
        ],
      },
  ...
  },
  {
    ...
    fullDescription:
      "One of the windiest places in Asia. Ramakkalmedu provides a breathtaking 360-degree view of the plains of Tamil Nadu and the hills of Kerala.",
    itinerary: [
      {
        day: 1,
        title: "On Top of the World",
        activities: [
          "Wind farm exploration",
          "Statue visit",
          "Off-road jeep trek",
          "Sunset at the peak",
        ],
  ...
  },
  {
    ...
    fullDescription:
      "Skip the lines and maximize the fun. Perfect for school trips and energetic groups looking for a day of pure excitement.",
    itinerary: [
      {
        day: 1,
        title: "The Ultimate Rush",
        activities: [
          "Full day theme park access",
          "Water park session",
          "Group lunch",
          "Evening wave pool party",
        ],
      },
    ],
  ...
  },
  {
    ...
    fullDescription:
      "A quick hop to the high altitudes. Experience the cool breeze of Kodaikanal, its iconic lake, and the serene walks through the park.",
    itinerary: [
      {
        day: 1,
        title: "High Altitude Hop",
        activities: [
          "Kodai lake boating",
          "Bryant park stroll",
          "Coaker's walk panorama",
  ...
  },
  {
    ...
    fullDescription:
      "The classic hill station experience. From heritage roses to the UNESCO-listed toy train, Ooty remains the quintessential mountain getaway.",
    itinerary: [
      {
        day: 1,
        title: "Nilgiri Legacy",
        activities: [
          "Botanical garden visit",
          "Dodabetta peak view",
          "Ooty lake boating",
          "Toy train experience (short duration)",
        ],
      },
    ],
  ...
  },
  {
    ...
    fullDescription:
      "Experience the edge of the subcontinent. Visit the rock memorial and witness the unique confluence of the Arabian Sea, Bay of Bengal, and Indian Ocean.",
    itinerary: [
      {
        day: 1,
        title: "Meeting of Oceans",
        activities: [
          "Sunrise viewing",
  ...
  },
  {
    ...
    fullDescription:
      "Cool off from the heat. Silver Storm and Dream World offer a variety of water and dry rides perfect for family outings and student groups.",
    itinerary: [
      {
        day: 1,
        ...
        activities: [
          ...
          "Snow park session",
          "Group activities & lunch",
          "Evening wave pool session",
        ],
      },
    ],
    inclusions: ["AC Coach", "Entry Tickets", "Locker access"],
  ...
  // 🗓️ TWO DAY PACKAGES
  {
    ...
    fullDescription:
      "The best of both worlds. Start with the serene meadows of Vagamon and overnight transition into the mist-heavy tea valleys of Munnar.",
    itinerary: [
      {
        day: 1,
        title: "Meadows & Pines",
        activities: [
          "Vagamon pine forest walk",
          "Meadow exploration",
          "Suicide point tour",
          "Drive to Munnar",
        ],
      },
      {
        day: 2,
        title: "Tea & Mist",
        activities: ["Munnar tea museum", "Gap road drive", "Echo point visit", "Return journey"],
      },
    ],
  ...
  },
  {
    ...
    fullDescription:
      "A journey through nature and time. Start in the emerald hills of Munnar and descend into the heritage forests of Marayoor.",
    itinerary: [
      {
        day: 1,
        title: "The Tea Trail",
        activities: ["Tea museum tour", "Eravikulam park", "Mattupetty dam", "Resort stay"],
      },
      {
        day: 2,
        title: "Ancient Secrets",
        activities: ["Sandalwood forest trek", "Stone dolmens visit", "Lakkam falls", "Return"],
      },
    ],
  ...
  },
  {
    ...
    fullDescription:
      "Kick off with the cool breeze of Munnar and end with the high-octane thrill of Wonderla Kochi. Perfect for batch trips.",
    itinerary: [
      {
        day: 1,
        title: "Mountain High",
        activities: ["Munnar sightseeing", "Tea garden walk", "Town shopping", "Transfer to Kochi"],
      },
      {
        day: 2,
        title: "Adrenaline Rush",
        activities: ["Full day at Wonderla Kochi", "Water park session", "Return journey"],
      },
    ],
  ...
  },
  {
    ...
    fullDescription:
      "A high-altitude weekend special. Experience the unique pine forests of both locations and the serenity of Kodai Lake.",
    itinerary: [
      {
        day: 1,
        title: "The Pine Loop",
        activities: ["Vagamon pine forest", "Meadow walk", "Drive to Kodaikanal", "Cottage stay"],
      },
      {
        day: 2,
        title: "Princess of Hills",
        activities: ["Kodai lake boating", "Bryant park", "Coaker's walk", "Return"],
      },
    ],
  ...
  },
  {
    ...
    fullDescription:
      "The best of the Western Ghats. Start with a jungle safari in the morning and end with heritage views in Ooty.",
    itinerary: [
      {
        day: 1,
        title: "Jungle Fever",
      ...
      },
      {
        ...
        activities: ["Botanical garden", "Ooty lake boating", "Toy train experience", "Return"],
      },
    ],
  ...
  },
  {
    ...
    fullDescription:
      "A royal road trip. Witness the grandeur of the Wodeyars before ascending the spectacular mountain roads to Ooty.",
    itinerary: [
      {
        day: 1,
        title: "The Royal Start",
        activities: [
          "Mysore palace tour",
          "Chamundi hill visit",
      ...
      },
      {
        ...
        activities: ["Rose garden visit", "Botanical gardens", "Ooty lake", "Return journey"],
      },
    ],
  ...
  },
  {
    ...
    fullDescription:
      "The quintessental Karnataka loop. Experience the princely heritage and the spiritual calm of the Tibetan monastery.",
    itinerary: [
      {
        day: 1,
        title: "Princely Mysore",
        activities: ["Mysore palace", "St. Philomena's", "Chamundi hill", "Resort stay in Coorg"],
      },
      {
        day: 2,
        title: "Scotland of India",
        activities: ["Abbey falls", "Golden temple (Bylakuppe)", "Raja's seat sunrise", "Return"],
      },
    ],
  ...
  },
  {
    ...
    fullDescription:
      "For lovers of architecture and nature. Witness the stone mastery of the medieval eras before retreating to the green heart of Coorg.",
    itinerary: [
      {
        day: 1,
        title: "Coffee Highlands",
        activities: ["Coorg plantation walk", "Abbey falls", "Golden temple", "Plantation stay"],
      },
      {
        day: 2,
        title: "Stone Masterclass",
        activities: [
          "Belur temple complex",
          "Halebidu ruins (optional)",
          "Coffee shopping",
          "Return",
        ],
      },
  ...
  },
  {
    ...
    fullDescription:
      "Two iconic coffee destinations in one go. From the highest peaks of Karnataka to the serene Tibetan settlements.",
    itinerary: [
      {
        day: 1,
        title: "Into the Mist",
        activities: ["Coorg sightseeing", "Golden temple", "Resort check-in", "Sunset bonfire"],
      },
      {
        day: 2,
        title: "Conquering Peaks",
        activities: ["Drive to Chikmagalur", "Mullayanagiri peak climb", "Coffee museum", "Return"],
      },
    ],
  ...
  },
  {
    ...
    fullDescription:
      "A perfect blend of city culture and high-octane fun. Visit the garden city's landmarks before heading to the biggest playground in the state.",
    itinerary: [
      {
        day: 1,
        title: "Garden City Vibe",
        activities: [
      ...
      },
      {
        ...
        activities: ["Full day at Wonderla Bangalore", "Water park session", "Evening return"],
      },
    ],
  ...
  },
  {
    ...
    fullDescription:
      "The iconic heritage loop. From modern tech hubs and Tudor palaces to the illuminated grandeur of the Wodeyars.",
    itinerary: [
      {
        day: 1,
        title: "Modern Mysore",
        activities: [
          "Mysore palace visit",
          "St. Philomena's",
          "Brindavan gardens illumination",
          "Mysore hotel stay",
        ],
      },
      {
        ...
        activities: ["Bangalore palace", "Lalbagh flowers", "Cubbon park", "Return journey"],
      },
    ],
  ...
  // 🗓️ THREE DAY PACKAGES
  {
    ...
    fullDescription:
      "Emirates' signature adventure. Start with ancient history, breathe in the mountain air, and end with the city's biggest thrills.",
    itinerary: [
      {
        day: 1,
        title: "Ancient Secrets",
        activities: ["Marayoor sandalwood forest", "Muniyaras", "Lakkam falls", "Resort stay"],
      },
      {
        day: 2,
        title: "Mountain High",
      ...
      },
      {
        day: 3,
        title: "The Rush",
        activities: ["Full day Wonderla Kochi", "Water park", "Return joinery"],
      },
    ],
  ...
  },
  {
    ...
    fullDescription:
      "A pure altitude adventure. Experience the rolling hills of Vagamon, the tea valleys of Munnar, and the sandalwood mists of Marayoor.",
    itinerary: [
      {
        day: 1,
        title: "Meadows & Pines",
        activities: ["Vagamon sightseeing", "Meadow walk", "Bonfire night", "Stay"],
      },
      {
        day: 2,
        title: "Tea Peaks",
        activities: ["Drive to Munnar", "Tea museum tour", "Gap road scenic drive", "Stay"],
      },
      {
        day: 3,
        title: "Heritage Loop",
        activities: ["Marayoor dolmens", "Sandalwood forest", "Lakkam falls", "Return"],
      },
    ],
  ...
  },
  {
    ...
    fullDescription:
      "Experience the unique climates of the Palani hills and the Western Ghats. A journey for mists, meadows, and stone history.",
    itinerary: [
      {
        day: 1,
        title: "High Meadows",
        activities: ["Vagamon meadows", "Pine forest", "Transfer to Kodai", "Cottage stay"],
      },
      {
        day: 2,
        title: "Princess of Hills",
        activities: ["Kodai lake boating", "Cokers walk", "Bryant park", "Stay"],
      },
      {
        day: 3,
        title: "Ancient Descent",
        activities: ["Drive to Marayoor", "Dolmens visit", "Sandalwood walk", "Return"],
      },
    ],
  ...
  },
  {
    ...
    fullDescription:
      "Connecting the three gems of the border. Explore the deep woods, the aromatic plantations, and the princely palaces.",
    itinerary: [
      {
        day: 1,
        title: "The Wild Start",
        activities: ["Wayanad Muthanga safari", "Edakkal caves", "Drive to Coorg", "Resort stay"],
      },
      {
        day: 2,
        title: "Tibetan Calm",
        activities: ["Golden temple visit", "Abbey falls", "Raja's seat sunset", "Stay"],
      },
      {
        day: 3,
        title: "Imperial Finish",
        activities: ["Mysore palace visit", "St. Philomena's", "Town shopping", "Return"],
      },
    ],
  ...
  },
  {
    ...
    fullDescription:
      "A grand Karnataka odyssey. Experience the royal legacy of Mysore before conquering the mist-heavy peaks of Chikmagalur and Coorg.",
    itinerary: [
      {
        day: 1,
        title: "Royal Mysore",
      ...
      },
      {
        ...
        activities: ["Coorg plantation walk", "Abbey falls", "Golden temple", "Return"],
      },
    ],
  ...
  },
  {
    ...
    fullDescription:
      "For the refined traveler. Experience the incredible stone craftsmanship of the medieval eras and the aromatic soul of the coffee hills.",
    itinerary: [
      {
        day: 1,
        title: "Stone Masterclass",
        activities: [
          "Belur & Halebidu temple complex visit",
      ...
      {
        day: 2,
        title: "Highlands of Coffee",
        activities: ["Abbey falls", "Golden temple", "Plantation walk session", "Campfire stay"],
      },
      {
        day: 3,
        title: "Ancient Ascent",
        activities: ["Shravanabelagola visit", "Coffee shopping spree", "Return journey"],
      },
    ],
  ...
  },
  {
    ...
    fullDescription:
      "The ultimate altitude-to-ocean loop. Conquer the peaks before relaxing on the white sands of the coastal islands.",
    itinerary: [
      {
        day: 1,
        title: "Peak High",
        activities: ["Chikmagalur peaks expedition", "Mullayanagiri trek", "Jungle stay"],
      },
      {
        day: 2,
        title: "Coffee hills",
        activities: ["Coorg coffee walk", "Transfer to Udupi coast", "Beach resort check-in"],
      },
      {
        day: 3,
        title: "Sacred Shores",
        activities: ["Malpe beach & island visit", "Udupi temple visit", "Return journey"],
      },
    ],
  ...
  },
  {
    ...
    fullDescription:
      "A comprehensive Karnataka expedition. Start with the metropolitan gardens and Tudor palaces before heading deep into the coffee hills.",
    itinerary: [
      {
        day: 1,
        title: "City of Gardens",
        activities: ["Bangalore palace", "Lalbagh garden stroll", "Transfer to hills", "Hill stay"],
      },
      {
        day: 2,
        title: "Summit Challenge",
        activities: [
          "Chikmagalur peaks full day",
          "Coffee museum visit",
          "Transfer to Coorg",
          "Resort stay",
        ],
      ...
      {
        day: 3,
        title: "Plantation Soul",
        activities: ["Coorg plantation walk", "Abbey falls visit", "Golden temple", "Return"],
      },
    ],
  ...
  },
  {
    ...
    fullDescription:
      "Our most requested group loop. Connecting the modern city, the royal legacy, and the natural heights of the state.",
    itinerary: [
      {
        day: 1,
        title: "Garden City Vibe",
      ...
      {
        day: 3,
        title: "Coffee Heights",
        activities: ["Coorg morning hills walk", "Abbey falls", "Shopping", "Return journey"],
      },
    ],
  ...
  // 🗓️ FOUR DAY PACKAGES
  {
    ...
    fullDescription:
      "Designed for the young and the energetic. This mega-loop connects the two most iconic hill stations with the wild heart of Wayanad and the state's biggest theme park.",
    itinerary: [
      {
        day: 1,
        title: "Alpine Heritage",
        activities: ["Ooty botanical garden", "Toy train experience", "Dodabetta peak", "Stay"],
      },
      {
        day: 2,
        title: "Mist Princess",
        activities: ["Transfer to Kodaikanal", "Lakside walk", "Bryant park", "Campfire night"],
      },
      {
        day: 3,
        title: "Jungle Fever",
        activities: ["Drive to Wayanad", "Wildlife safari Muthanga", "Forest stay"],
      },
      {
        day: 4,
        title: "Theme Park Takeover",
        activities: ["Wonderla Kochi full day", "Water park session", "Group celebration return"],
      },
    ],
    inclusions: [
      "Flagship Coach",
  ...
  },
  {
    ...
    fullDescription:
      "A sophisticated exploration of the Western Ghats. From deep jungle safaris to the intricate stone carvings of the Hoysala dynasty.",
    itinerary: [
      {
        day: 1,
        title: "Jungle Vibe",
        activities: ["Wayanad wildlife safari", "Edakkal caves", "Drive to Coorg", "Resort stay"],
      },
      {
        day: 2,
        title: "Coffee Culture",
        activities: ["Full day Coorg sightseeing", "Abbey falls", "Golden temple", "Stay"],
      },
      {
        day: 3,
        title: "Stone Legacy",
        activities: [
          "Transfer to Belur/Halebidu",
          "Stone architecture tour",
          "Stay at Chikmagalur",
        ],
      },
      {
        day: 4,
        title: "Summit View",
        activities: ["Mullayanagiri peak trek", "Coffee museum", "Return journey"],
      },
    ],
  ...
  },
  {
    ...
    fullDescription:
      "The ultimate diverse loop. Experience the three distinct terrains of the state: the wild jungles, the royal plains, and the pristine coast.",
    itinerary: [
      {
        day: 1,
        title: "Forest Aura",
        activities: ["Wayanad muthanga safari", "Lakkidi view", "Transfer to Mysore", "Stay"],
      },
      {
        day: 2,
        title: "Princely Plain",
        activities: ["Mysore palace tour", "Chamundi hill", "Transfer to Coorg", "Stay"],
      },
      {
        day: 3,
        title: "Spices & Spirit",
        activities: ["Abbey falls", "Golden temple", "Transfer to coast", "Island boat trip"],
      },
      {
        day: 4,
        title: "Sacred Coast",
        activities: ["Udupi temple visit", "Malpe beach sport", "Final group lunch", "Return"],
      },
    ],
    inclusions: [
      "Premium Coach",
      "Mix of Classic Stays",
      "Breakfast daily",
      "Island Ferry",
      "Licensed Crew",
    ],
  ...
  },
  {
    ...
    fullDescription:
      "A high-fidelity Karnataka loop for families and corporations. Witness the stone granduer of the royals before relaxing in the hills and ending with a bang.",
    itinerary: [
      {
        day: 1,
        title: "Imperial Start",
        activities: ["Mysore palace full day", "Brindavan flowers", "Heritage stay"],
      },
      {
        day: 2,
        title: "Mountain High",
        activities: ["Transfer to Coorg", "Abbey falls", "Plantation walk", "Stay"],
      },
      {
        day: 3,
      ...
      },
      {
        day: 4,
        title: "Thrills Peak",
        activities: ["Full day at Wonderla Bangalore", "Water park session", "Group return"],
      },
    ],
  ...
  },
  {
    ...
    fullDescription:
      "A journey across time and terrain. From the medieval masterpieces of the Hoysalas to the pristine coastal charm of the Arabian Sea islands.",
    itinerary: [
      {
        day: 1,
        title: "Royal Pride",
        activities: ["Mysore palace tour", "St. Philomena's", "Town shopping", "Heritage stay"],
      },
      {
        day: 2,
        title: "Coffee Hills",
        activities: ["Drive through Coorg", "Golden temple visit", "Abbey falls", "Resort stay"],
      },
      {
        day: 3,
        title: "Stone Mastery",
        activities: ["Belur temple complex", "Halebidu ruins", "Transfer to coast", "Stay"],
      },
      {
        day: 4,
        title: "Island Soul",
        activities: ["Malpe island visit", "Boat ferry", "Beach sports", "Return journey"],
      },
    ],
    inclusions: [
      "AC Coach",
  ...
  // 🗓️ FIVE DAY PACKAGES
  {
    ...
    image: goa1,
    blurb:
      "Connect the pristine islands of Malpe with the beach soul of Goa and the river rapids of Dandeli.",
    highlights: ["Goa Beach Night", "Dandeli Rafting", "Malpe Island", "Abbey Falls"],
    fullDescription:
      "Emirates' most diverse long-haul loop. Experience the white sands, the dense jungles, the river adventures, and the aromatic hills of Coorg in one epic odyssey.",
    itinerary: [
      {
        day: 1,
        title: "Island Reach",
      ...
      },
      {
        ...
        activities: [
          "Drive to Goa",
          "South Goa beach relaxation",
          "Evening party/dinner at shack",
          "Goa stay",
        ],
      },
      {
        day: 3,
        title: "Heritage & Sun",
        activities: ["Old Goa churches", "Panjim city tour", "Anjuna beach sunset", "Stay"],
      },
      {
        day: 4,
        title: "River Pulse",
  ...
  },
  {
    ...
    image: goa1,
    blurb:
      "Connect the ruins of the Vijayanagara Empire with the rapids of Dandeli and the sands of Goa.",
    highlights: ["Hampi Stone Chariot", "Dandeli Rafting", "Goa Beach Party"],
    fullDescription:
      "A grand expedition across history and nature. Witness the boulder landscapes of Hampi, the dense woods of Dandeli, and the coastal vibrancy of Goa.",
    itinerary: [
      {
        day: 1,
        title: "Stone Empire",
      ...
      },
      {
        day: 3,
        title: "River Thrills",
        activities: ["Full day Dandeli river rafting", "Ziplining", "Nature Jacuzzi", "Stay"],
      },
      {
        day: 4,
        title: "Goan Spirit",
        activities: ["Transfer to Goa", "Sunset at beach", "Beach party", "Stay"],
      },
      {
        day: 5,
        title: "Coastal Heritage",
        activities: ["Old Goa tour", "Shopping", "Departure return"],
      },
    ],
    inclusions: [
      "Flagship Coach",
  ...
  },
  {
    ...
    image: hampi1,
    blurb:
      "Explore the metropolitan energy of Bangalore, the river wild of Dandeli, and the stone wonders of Hampi.",
    highlights: ["Bangalore Palace", "Dandeli Rafting", "Hampi Ruins"],
    fullDescription:
      "A comprehensive journey through Karnataka's heart. From the modern state capital to the ancient UNESCO world heritage landscapes and the adventure rapids of Kali river.",
    itinerary: [
      {
        day: 1,
        title: "Garden City",
        activities: ["Bangalore palace", "Lalbagh garden", "Commercial street shopping", "Stay"],
      },
      {
        day: 2,
        title: "Jungle Drive",
        activities: ["Transfer to Dandeli", "Jungle trekking", "Camp check-in", "Bonfire"],
      },
      {
        day: 3,
        title: "Water Pulse",
      ...
      },
      {
        day: 4,
        title: "Stone Masterclass",
        activities: ["Hampi full day tour", "Vittala temple", "Sunset at Matanga hill", "Stay"],
      },
      {
        day: 5,
        title: "Final Legacy",
        activities: ["Anegundi visit", "Final group lunch", "Return journey"],
      },
    ],
  ...
  },
  {
    ...
    image: goa1,
    blurb:
      "Experience the ultimate contrast: The cinematic ruins of Hampi and the world-famous beaches of Goa.",
    highlights: ["Hampi Archaeolgoy", "Old Goa Heritage", "Sunset Beach Dinners"],
    fullDescription:
      "A sophisticated expedition for those who seek both culture and relaxation. Spend two days lost in the stone wonders of Vijayanagara before immersing yourself in the Goan lifestyle.",
    itinerary: [
      {
        day: 1,
        title: "Ruins at Dawn",
        activities: ["Arrival in Hampi", "Virupaksha temple session", "Riverside ruins", "Stay"],
      },
      {
        day: 2,
        title: "Boulder Landscape",
        activities: ["Matanga hill sunrise", "Stone chariot visit", "Anegundi loop", "Stay"],
      },
      {
        day: 3,
        title: "Path to Paradise",
        activities: ["Transfer to Goa", "Sunset beach walk", "Seafood dinner session", "Stay"],
      },
      {
        day: 4,
        title: "Portuguese Soul",
        activities: [
          "Old Goa churches",
      ...
      },
      {
        day: 5,
        title: "Island Vibe",
        activities: ["Divar island (optional)", "Final shopping", "Departure return"],
      },
    ],
    inclusions: [
      "Premium Coach",
      "Heritage & Beach Stays",
      "Breakfasts daily",
      "Archaeologist Guide",
    ],
    exclusions: ["Lunch", "Entry permits"],
  ...
  },
  {
    ...
    fullDescription:
      "The high-energy vacation. Start with the wild rapids and jungle camps of Dandeli and wind down with the iconic beach energy of Goa.",
    itinerary: [
      {
        day: 1,
        title: "Into the Rapid",
        activities: ["Arrival in Dandeli", "River rafting intro", "Jungle camp stay", "Bonfire"],
      },
      {
        day: 2,
        title: "Adventure Peak",
        activities: ["Full day river activities", "Ziplining", "Zack boat ride", "Stay"],
      },
      {
        day: 3,
        ...
        activities: [
          "Transfer to Goa",
          "North Goa beach check-in",
          "Sunset market session",
          "Stay",
        ],
      },
      {
        day: 4,
        title: "Beach Hopping",
        activities: ["Vagator/Anjuna beaches", "Chapora fort visit", "Beach party night", "Stay"],
      },
